...
Во время перемещения служба OneDrive пользователя доступна только для чтения. Когда перемещение завершится, при попытке пользователя перейти к OneDrive в средстве запуска приложений Microsoft 365 или веб-браузере он будет направлен к OneDrive в новом географическом расположении.
