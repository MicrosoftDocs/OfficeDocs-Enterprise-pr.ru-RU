...
1. С помощью браузера на одном компьютере или из CLIENT1, войдите в портал Office 365 по [https://portal.office.com](https://portal.office.com) с использованием учетных данных учетной записи глобального администратора.
