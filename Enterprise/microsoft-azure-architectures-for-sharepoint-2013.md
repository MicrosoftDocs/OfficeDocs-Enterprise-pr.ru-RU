...
# Архитектуры Microsoft Azure для SharePoint 2013
...
## Рекомендуемые решения SharePoint для служб инфраструктуры Azure
...
## Определение типа домена Active Directory
...
## Добавление подключения между организациями
...
## Добавление Active Directory (AD) на сервере Windows Server и DNS
...
## Разработка и точная настройка ролей серверов для групп доступности и доменов сбоя
