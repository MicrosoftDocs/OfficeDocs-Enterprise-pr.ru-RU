...
[Облачное удостоверение](about-office-365-identity.md) — создание пользователей и управление ими в центре администрирования Office 365 Кроме того, вы можете использовать Windows PowerShell или Azure Active Directory для управления пользователями. 
...
Если вы не можете консолидировать развертывание службы развертывания Active Directory на различных лесах или использовать другие службы каталогов для управления удостоверениями, их можно синхронизировать с помощью корпорации Майкрософт или партнера.
