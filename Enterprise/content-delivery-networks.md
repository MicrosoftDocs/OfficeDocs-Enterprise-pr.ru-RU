...
|Сеть CDN Microsoft AJAX (только чтение)     |Microsoft         |Общие библиотеки для AJAX, jQuery, ASP.NET, начальной загрузки, Knockout.js и т. д.         |[Сеть CDN Microsoft AJAX](https://docs.microsoft.com/aspnet/ajax/cdn/overview)         |
