...
1. Перейдите в **Центр администрирования** > **Управление приложениями** > **Управление веб-приложениями**и выберите веб-приложение, которое должно быть расширены для использования протокола SSL. Выберите веб-приложение и нажмите кнопку **ленты расширить** . Расширение веб-приложения, чтобы использовать же URL-адрес, но использование SSL с порт 443.</br>![Расширение веб-приложения на другой сайт служб IIS](images/SAML11/fig3-extendwebapptoiis.png)</br>
2. В Диспетчер IIS дважды щелкните **Сертификаты сервера**.
3. В области **действий** выберите **Создать самозаверяющий сертификат**. Введите понятное имя для сертификата в поле укажите понятное имя сертификата и нажмите кнопку **ОК**.
4. В диалоговом окне **Изменение привязки сайта** убедитесь, что имя узла — это понятное имя, как показано на следующем рисунке.</br>![Изменение привязки сайта в IIS](images/SAML11/fig4-editsitebinding.png)</br>
...
5. Щелкните ссылку **настроить (app name)** для доступа к странице настройки единого входа.</br>![Настройка единого входа на страницу](images/SAML11/fig7-configssopage.png)</br> 
...
6.  Перейдите в области **свойств** для приложения. Скопируйте и вставьте значение идентификатора объекта в таблице, настроенных в шаге 3.</br>![Область свойств для приложения](images/SAML11/fig8-propertiespane.png)</br>
...
|---------|---------|
|Область | `urn:sharepoint:portal.contoso.local` |
...
4. В политике для веб-приложения нажмите кнопку **Добавить пользователей**.</br>![Поиск пользователя с их имя утверждения](images/SAML11/fig11-searchbynameclaim.png)</br>
