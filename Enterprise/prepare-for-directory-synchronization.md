...
1. Убедитесь, что у каждого пользователя, которому будет назначена служба Office 365, есть действительный и уникальный адрес электронной почты в атрибуте **proxyAddresses** . 
...
4. Для оптимального использования глобального списка адресов (GAL) необходимо убедиться в правильности сведений в следующих атрибутах:
...
## <a name="directory-object-and-attribute-preparation"></a>Подготовка объекта каталога и атрибута
...
- **userPrincipalName**
  ...
  - Максимальное число символов для имени пользователя перед знаком "@": 64
