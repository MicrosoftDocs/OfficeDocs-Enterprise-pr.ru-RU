...
Дополнительные сведения о современной проверке подлинности в Office 365 см. в статье [Поддержка клиентских приложений Office 365: современная проверка подлинности](office-365-client-support-modern-authentication.md).
