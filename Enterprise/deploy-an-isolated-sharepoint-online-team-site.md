...
3. На blade **все группы** нажмите кнопку **+ новую группу**.
    
4. На blade **группы** :
    
  - В поле **имя**введите имя группы.
    
  - Выберите **назначенные** **членства**.
    
  - Для **включения Office компонентов**, нажмите кнопку **Да** .
    
5. Нажмите кнопку **Создать**, а затем закройте blade **группы** .
...
2. В области **разрешения для сайта** выберите **Параметры дополнительные разрешения**.
    
3. На вкладке **разрешения** нового браузера щелкните **Параметры запроса доступа**.
...
16. Закройте вкладку **разрешения** браузера.
