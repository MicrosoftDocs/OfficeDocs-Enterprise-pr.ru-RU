...
- Достигнут конец поддержки продуктов и служб Office 2007. Более подробную информацию можно найти [в статье обновление серверов и клиентов Office 2007](upgrade-from-office-2007-servers-and-products.md) .

- Для серверов и клиентов Office 2010:

  - На сервере Exchange 2010 будет достигнут конец поддержки **14 января 2020 г**.

  - Для Office 2010, SharePoint 2010 и Project Server 2010 достигнут конец поддержки **13 октября 2020 г**.

Более подробную информацию можно найти [в статье обновление серверов и клиентов Office 2010](upgrade-from-office-2010-servers-and-products.md) .
...
- **Внедрение гибридного решения в Office 365 или Microsoft 365.** Гибридная среда использует как локальные серверы, так и приложения, а также их облачные эквиваленты. Если вы перемещаетесь в облако поэтапно или хотите оставить некоторые серверы и приложения локально, гибридное решение может оказаться для вашей организации. Подробные сведения о [гибридных облачных решениях Office 365](hybrid-cloud-overview.md) . 
    
- **Перейдите в облако с помощью Office 365 или Microsoft 365.** Для многих клиентов перемещение в облако является эффективным и экономически эффективным решением. Перемещаясь полностью в облако, вы можете легко и быстро установить все последние функции и обновления для системы безопасности. Сведения о [том, что такое Microsoft 365?](#what-is-microsoft-365) в этой статье, чтобы получить дополнительные сведения.
...
- Если ваша организация приобрела определенное количество лицензий на Office 365, наша группа FastTrack поможет вам выполнить процесс установки. Дополнительные сведения можно узнать в статье [FastTrack for Office 365](https://www.microsoft.com/fasttrack/microsoft-365/office-365).
...
- **Бесплатно Используйте Office в браузере.** Создавать, просматривать и редактировать файлы Office в браузере, а также получать доступ к этим файлам практически с любого устройства, имеющего доступ к Интернету. [Office для Интернета](https://products.office.com/office-online/documents-spreadsheets-presentations-office-online) включает [в себя Word](http://go.microsoft.com/fwlink/p/?linkid=746664)для Интернета, [Excel для Интернета](http://go.microsoft.com/fwlink/p/?linkid=746665), [PowerPoint](http://go.microsoft.com/fwlink/p/?linkid=746666)для Интернета, [OneNote для Интернета](http://go.microsoft.com/fwlink/p/?linkid=746674), [презентацию Sway](http://go.microsoft.com/fwlink/p/?linkid=746675), [электронную почту](http://go.microsoft.com/fwlink/p/?linkid=746676), [Календарь](http://go.microsoft.com/fwlink/p/?linkid=746678)и [OneDrive](http://go.microsoft.com/fwlink/p/?linkid=746679). Чтобы приступить к работе, перейдите по адресу [Office.com](https://office.com) и войдите в свою [учетную запись Майкрософт](https://account.microsoft.com/account). (Если у вас нет учетной записи Майкрософт, вы можете создать ее по адресу [Office.com](https://office.com).)

- **Попробуйте Office 365 для домашнего использования.** Ознакомьтесь с [требованиями](https://www.microsoft.com/p/office-365-home/cfq7ttc0k5dm?rtc=1&activetab=pivot:techspecstab), а затем выберите вариант между [Office 365 Домашняя](https://www.microsoft.com/p/office-365-home/cfq7ttc0k5dm) или [Office 365 персональный](https://www.microsoft.com/p/office-365-personal/cfq7ttc0k5bf). Запустите пробную версию и Узнайте, как работает Office 365. В Office 365 вы будете работать с облачным хранилищем в OneDrive, вы получите 60 минут вызовов Skype для мобильных телефонов и стационарный, и вы получите множество других замечательных функций. Чтобы узнать больше, ознакомьтесь с статьей Узнайте больше [от Office с office 365](https://products.office.com/compare-all-microsoft-office-products?&activetab=tab%3aprimaryr1).

   В [конце поддержки Windows 7 (14 января 2020](https://www.microsoft.com/windowsforbusiness/end-of-windows-7-support)) версии Word, Excel, PowerPoint, Outlook, Publisher и Access, предоставляемые Office 365 для дома или Office 365 Personal на устройствах с Windows 7, будут получать обновления для системы безопасности, но компонент не используется обновления. Чтобы продолжить получать обновления компонентов для этих приложений, [Обновите устройства с Windows 7 до Windows 10](https://support.microsoft.com/help/12435/windows-10-upgrade-faq).
...
- **Приобретение домашнего &amp; учащегося для Office.** Если выбран этот вариант, вы сделаете разовую покупку и установили Office на компьютере с Windows или Mac. Эта подписка не является подпискум; Это одноразовая лицензия бессрочного использования для одного компьютера. Просмотрите [требования](http://office.com/systemrequirements), а затем выберите нужную версию.
    ...
    - Если на компьютере с Windows установлена ОС Windows 7, 8 или 8,1 и в настоящее время вы не выполняете обновление до Windows 10, рассмотрите возможность загрузки Office домашней & 2016 учащихся (или другой выпуск Microsoft Office) от авторизованного торгового посредника.
     ...
     - Поддержка Windows 7 [заканчивается 14 января 2020](https://www.microsoft.com/windowsforbusiness/end-of-windows-7-support), после чего корпорация Майкрософт не будет предоставлять обновления или поддержку для системы безопасности. Обновление устройств с Windows 7 до Windows 10 для обеспечения безопасности и обновления компонентов и постоянной поддержки.

Вы также можете отказаться от обновления в данный момент. Приложения Office продолжат работу. В [этой статье](https://go.microsoft.com/fwlink/p/?linkid=2085724)представлены даты поддержки для Office. Однако обновление предоставит вам обновления для системы безопасности или новые и улучшенные функции.
...
Несмотря на то, что вы можете перенести серверы и клиенты Office 2007 или Office 2010 в Office 365, Microsoft 365 включает лицензии и возможности, чтобы обеспечить работу Организации в новейшей операционной системе Windows, а также на устройствах, включая Windows, iOS и Android — регистрируются и защищаются с помощью политик, требующих проверки подлинности и защиты данных. Кроме того, Windows 10 и клиентское программное обеспечение Office 365 профессиональный плюс обновляются на основе новейших компонентов и обновлений для системы безопасности.
