...
4. В области активные пользователи щелкните **дополнительные > настройке многофакторной проверки подлинности**.
...
2. Перейдите на портал Office 365 ([https://www.office.com](https://www.office.com)) и войдите в систему с учетной записью пользователя 2\<(user2@ имя Организации>. onmicrosoft.com) и пароль.
