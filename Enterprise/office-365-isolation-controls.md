...
Сведения о том, как Майкрософт реализует логическую изоляцию данных клиента в Microsoft 365, можно узнать [в разделе изоляция клиента в microsoft 365](office-365-tenant-isolation-overview.md).
