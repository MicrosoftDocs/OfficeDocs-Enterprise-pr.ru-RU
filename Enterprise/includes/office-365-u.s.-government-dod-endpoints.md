...
10  | По умолчанию<BR>Обязательно | Нет | `*.wns.windows.com, ajax.aspnetcdn.com, g.live.com, odc.officeapps.live.com, officeclient.microsoft.com, oneclient.sfx.ms` | **TCP:** 443, 80
...
23 | Разрешить<BR>Обязательно | Да | `dod.loki.office365.us`<BR>`52.127.72.34/32, 52.127.76.35/32` | **TCP:** 443
