...
SP4 | По умолчанию<BR>Обязательно | Да | `attachments.office365-net.us, autodiscover.<tenant>.mail.onmicrosoft.com, autodiscover.<tenant>.mail.onmicrosoft.us, autodiscover.<tenant>.onmicrosoft.com, autodiscover.<tenant>.onmicrosoft.us, autodiscover-s.office365.us` | **TCP:** 443, 80
...
ID | Категория | ER | Addresses | Порты
-- | -------------------- | --- | ------------------------------------------------------------------------------------------------------------------------------------------- | ----------------
10 | Оптимизация<BR>Обязательно | Да | `*.sharepoint.us`<BR>`20.34.8.0/22, 104.212.50.0/23, 2001:489a:2204:2::/63, 2001:489a:2204:800::/54` | **TCP:** 443, 80
десяти | По умолчанию<BR>Обязательно | Нет | `admin.onedrive.us, ajax.aspnetcdn.com, g.live.com, odc.officeapps.live.com, officeclient.microsoft.com, oneclient.sfx.ms, wns.windows.com` | **TCP:** 443, 80
...
ID | Категория | ER | Addresses | Порты
-- | ------------------- | --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------
-11:00 | Разрешить<BR>Обязательно | Да | `*.gov.online.office365.us`<BR>`52.127.82.0/23` | **TCP:** 443
...
16  | Разрешить<BR>Обязательно | Да | `portal.office365.us, webshell.suite.office365.us, www.office365.us`<BR>`13.72.179.48/32, 13.72.188.8/32, 52.227.167.206/32, 52.227.170.242/32` | **TCP:** 443, 80
17 | Разрешить<BR>Обязательно | Да | `*.osi.office365.us, tasks.office365.us`<BR>`52.127.240.0/20, 2001:489a:2206::/48` | **TCP:** 443
...
22 | По умолчанию<BR>Обязательно | Нет | `gcchigh.loki.office365.us, lpcres.delve.office.com` | **TCP:** 443
