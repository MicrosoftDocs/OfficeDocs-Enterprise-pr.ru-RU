...
10  | По умолчанию<BR>Обязательно | Нет | `*.wns.windows.com, admin.onedrive.us, ajax.aspnetcdn.com, g.live.com, odc.officeapps.live.com, officeclient.microsoft.com, oneclient.sfx.ms` | **TCP:** 443, 80
...
22 | Разрешить<BR>Обязательно | Да | `gcchigh.loki.office365.us`<BR>`52.127.240.40/32, 52.127.244.46/32` | **TCP:** 443
