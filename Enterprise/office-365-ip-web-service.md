...
- category — категория возможности подключения к набору конечных точек. Допустимые значения: Optimize, Allow и Default. Обязательный элемент.
...
- disposition может представлять изменение, добавление или удаление. Описывает, как именно была изменена запись набора конечных точек. Обязательный элемент.
