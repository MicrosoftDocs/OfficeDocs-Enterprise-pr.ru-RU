...
|:----|:---------|
|Файлы, находившиеся на вкладке "Файлы" перед географическим перемещением, не удается открыть в Teams.|Откройте файл из SharePoint.|
|Файлы, к которым до географического перемещения был предоставлен общий доступ в беседах, не открываются в классической версии Teams.|Откройте файл из вкладки "Файлы".|
|Вкладка "Файлы" канала может не открываться с первой попытки после географического перемещения.|Откройте вкладку "Файлы" повторно.|
|Отправка файла в беседе канала может не сработать после перемещения сайта.|Отправьте файлы с помощью вкладки "Файлы".|
|Поиск файлов в Teams не дает результатов после географического перемещения.|Найдите файлы с помощью вкладки "Файлы".|
|В представлении Microsoft Teams в приложении "Файлы" (левая панель навигации) файлы могут не отображаться до тех пор, пока не будет обновлена вкладка "Файлы" географически перемещенного сайта.|Откройте вкладку "Файлы" для перемещенного сайта.|
