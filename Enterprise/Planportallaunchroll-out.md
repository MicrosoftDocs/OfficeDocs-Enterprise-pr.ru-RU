...
Портал — это сайт SharePoint по умолчанию для вашей компании; в крупных организациях может быть несколько из них. Если вы ожидали более 20% пользователей в вашей организации для доступа к странице, следует учесть, что страница портала. Это не следует путать с сайтом группы, используемым в отделе для совместной совместной использования и совместного использования документов в команде.
...
Дополнительные сведения: [SharePoint Online по планированию мощности и тестированию нагрузки](https://docs.microsoft.com/en-us/office365/enterprise/capacity-planning-and-load-testing-sharepoint-online)
