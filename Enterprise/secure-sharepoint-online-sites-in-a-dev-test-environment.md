...
9. У метки **Строго конфиденциальный** щелкните многоточие (…), а затем выберите команду **Добавить вложенную метку**.
    
10. Введите имя вложенной метки в поле **Имя** и ее описание в поле **Описание**.
    
11. В разделе **Задайте разрешения для документов и электронных писем, имеющих эту метку** нажмите кнопку **Защитить**.
    
12. В разделе **Защита** выберите **Azure (облачный ключ)**.
    
13. В колонке **Защита** в разделе **Параметры защиты** нажмите кнопку **+ Добавить разрешения**.
    
14. В колонке **Добавление разрешений** в разделе **Укажите пользователей и группы** нажмите кнопку **+ Обзор каталога**.
...
19. Закройте новую колонку политики области.
