...
Чтобы узнать больше о сервере Office Web Apps, скачайте упрощенный плакат о развертывании Office Web http://aka.ms/OfficeWebAppsPosterApps на сайте. 
...
- Сервер SharePoint с конечной точкой метаданных JSON для https://<web app name>/_layouts/15/Metadata/JSON/1 
...
- Использование фотографий высокого разрешения в Exchange 2013 из SharePoint Server 2013 (http://aka.ms/Bhr4d2) 
...
Эскизы видео улучшают внешний вид и функции библиотеки ресурсов. Чтобы узнать больше о создании эскизов для записи собраний, ознакомьтесь со статьей запись или изменение эскиза видео, http://aka.ms/Kupj85расположенного по адресу. На плакате также имеется QR-код для доступа к этой информации. 
