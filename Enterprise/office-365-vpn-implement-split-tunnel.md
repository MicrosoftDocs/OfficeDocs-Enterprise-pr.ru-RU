...
- Запустите [проверку подключения к Microsoft 365](https://aka.ms/netonboard), чтобы проверить маршруты трассировки, указанные выше. Мы также добавляем в это тестирование VPN-тесты, которые также должны дать некоторую дополнительную информацию.
