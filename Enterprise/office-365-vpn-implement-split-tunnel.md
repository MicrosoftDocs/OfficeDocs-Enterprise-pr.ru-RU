...
>[!IMPORTANT]
>Чтобы обеспечить направление медиа-трафика Teams через нужный метод во всех сценариях VPN, убедитесь, что используется версия клиента не ниже указанной, так как в этих версиях улучшено обнаружение доступных сетевых путей клиентом.<br>Номер версии Windows:  **1.3.00.9267**<br>Номер версии Mac: **1.3.00.9221**
