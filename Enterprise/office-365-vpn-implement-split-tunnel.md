...
Во время записи диапазонов IP-адресов, соответствующих конечным точкам, будут выглядеть следующим образом. **Настоятельно** рекомендуется использовать [сценарий, такой как этот](https://github.com/microsoft/Office365NetworkTools/tree/master/Scripts/Display%20URL-IPs-Ports%20per%20Category) пример, [веб-службу IP-адресов и URL-адресов Office 365](https://docs.microsoft.com/office365/enterprise/office-365-ip-web-service) или [страницу URL-адресов / IP-адресов](https://docs.microsoft.com/office365/enterprise/urls-and-ip-address-ranges), чтобы проверить наличие обновлений при применении конфигурации, и установить политику для этого на регулярной основе. основа.
