...
Текущее требование для того, чтобы это работало в 100% сценариев, также должно добавить диапазон **13.107.60.1/32**. Это не должно быть необходимо очень скоро из-за обновления в последнем клиенте Teams, выход которого запланирован на **30 марта 2020 года**.
