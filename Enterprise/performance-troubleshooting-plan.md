...
Требуется измерять скорость подключения или пропускную способность подключения к поставщику услуг Интернета? Попробуйте этот сайт (или сайты, такие как он): [Официальный сайт спидтест](https://www.speedtest.net/)и [пингтест](https://www.pingtest.net/).
