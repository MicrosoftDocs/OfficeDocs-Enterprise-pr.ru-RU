...
- [Анализатор](https://technet.microsoft.com/library/jj649776.aspx)сообщений (Майкрософт): анализатор сообщений является эффективным средством устранения проблем с сетью. Анализатор сообщений захватывает, отображает и анализирует трафик сообщений на основе протоколов и системные сообщения. Анализатор сообщений также позволяет импортировать, объединять и анализировать данные из файлов журнала и трассировки.
