...
|||
|:-------|:-----|:-----|
|  | **Облачное удостоверение** | **Гибридное удостоверение** |
...
Для управления синхронизированными учетными записями пользователей в Azure AD не используется центр администрирования Microsoft 365 или оболочка Office 365.
