...
Как настроить среду несколькими географически пользователи увидят новости, последние и число сайтов из нескольких расположений географически на своей домашней странице SharePoint. При использовании поля поиска на домашней странице SharePoint, они только получать результаты из индекса поиска находится в расположения географически SPHome.
...
<p>На рисунке 1: Поиска в рамках клиента с тремя географического расположения</p></th>
<th align="left"><p>Поиск клиент вызывает конечная точка REST поиска с помощью свойства запроса EnableMultiGeoSearch = true.</p>
<p>Запрос отправляется все географического расположения в клиентов.</p>
<p>Результаты поиска из каждого географического расположения объединенных и ранжирования.</p>
<p>Клиент получает результаты объединенных поиска.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
### Получить центра поиска, чтобы показать результаты из всех расположений географически
...
3.  Выберите вертикальная для установки, щелкните значок шестеренки **Параметры** в верхнем правом углу окна и выберите команду **Изменить страницу**.

> ![](media/configure-search-for-multi-geo_image2.png)
>
> Откроется страница результатов поиска в режиме редактирования.

1.  В веб-части результатов поиска наведите указатель на верхний правый угол веб-части щелкните стрелку и выберите в меню команду **Изменить веб-часть** . ![](media/configure-search-for-multi-geo_image3.png)

> Откроется панель инструмента веб-части результатов поиска в разделе ленты в верхней правой части страницы.
...
<td align="left">Запрос не несколькими географически запроса и не было fanned в работе на других географического расположения.</td>
</tr>
</tbody>
</table>
