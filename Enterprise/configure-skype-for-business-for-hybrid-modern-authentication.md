...
Кроме того, если рисунок в этой статье содержит затененный или затененный объект, значит элемент, отображаемый серым цветом, **не** включается в конфигурацию, характерную для MA.
