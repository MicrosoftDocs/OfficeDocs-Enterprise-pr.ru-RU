...
2. Чтобы открыть компонент "работоспособность службы", в центре администрирования **** > выберите**работоспособность службы**работоспособности или щелкните **карточку работоспособности службы** на **панели мониторинга "Домашняя страница"**. На карточке указано, есть ли проблемы со службой, и приведена ссылка на подробную информацию.
...
Работоспособность службы позволяет просматривать текущее состояние работоспособности и просматривать историю всех помощников и инцидентов обслуживания, которые затронут клиент за последние 30 дней. Для этого щелкните ссылку **Просмотреть журнал** на странице **Работоспособность службы**. 
