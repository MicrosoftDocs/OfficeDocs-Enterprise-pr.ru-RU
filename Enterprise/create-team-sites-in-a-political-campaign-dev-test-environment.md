...
5. В колонке **Azure Information Protection** выберите **Политики в области > Добавить политику**.
    
6. Введите **СтратегияКампании** в поле **Имя политики** и **Метка для документов на сайте группы "Стратегия кампании"** в поле **Описание**.
    
7. Щелкните **Выберите, к каким пользователям или группам будет применяться эта политика > Пользователи или группы**, а затем выберите **Старший и стратегический персонал**.
    
8. Щелкните **Выбрать > ОК**.
...
15. В области **Пользователи и группы AAD** выберите группу **Старший и стратегический персонал** и нажмите кнопку **Выбрать**.
...
19. Закройте колонку новой политики в области.
    
20. В колонке **Azure Information Protection — политики в области** нажмите кнопку **Опубликовать**, а затем выберите **Да**.
...
[Руководства по лабораториям тестирования (TLG) для освоения облачных решений](cloud-adoption-test-lab-guides-tlgs.md)
