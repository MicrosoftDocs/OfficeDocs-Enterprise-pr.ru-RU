...
Пользователи в Китае, которые подключаются к глобальным клиентам Office 365 из удаленных расположений, таких как Гостиницы, кафе, Гостиницы и офисы филиалов без подключения к корпоративным сетям, могут испытывать низкую производительность сети, так как трафик между устройствами и Office 365 должен пройти перегрузку перегрузки сетевых каналов перегрузки в Китае.
