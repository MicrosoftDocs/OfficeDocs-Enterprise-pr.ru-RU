...
## <a name="power-bi-collaboration-options"></a>Совместная работа Электропитание бизнес-Аналитики

|**Цель общего доступа**|**Функции администрирования**|**Инструкции**|
|:-----|:-----|:-----|
|Power BI позволяет пользователям внешних гостевой пользоваться содержимым, общих для их по ссылкам. Это позволяет пользователям в организации для распределения контента безопасным способом во всех организациях.<br/> | Admin Power бизнес-Аналитики можно управлять, могут ли пользователи приглашать внешних пользователей для просмотра контента в рамках организации. <br/> |[Распространение Power BI контента для внешних Гости с Azure AD B2B](https://docs.microsoft.com/en-us/power-bi/service-admin-azure-ad-b2b) <br/> |
