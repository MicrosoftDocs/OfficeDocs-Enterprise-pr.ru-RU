...
Чтобы гости могли иметь доступ к файлам в Teams, параметры общего доступа на уровне Организации SharePoint должны разрешить совместное использование с гостями.
...
2. Выберите сайт только что созданной команды.
