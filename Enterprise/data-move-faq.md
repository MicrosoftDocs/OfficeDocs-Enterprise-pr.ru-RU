...
Мы можем иметь возможность принимать запросы на основе исключения, чтобы предоставить вашему клиенту крайний срок для завершения перемещения.   Обратитесь в [службу поддержки Office 365](https://go.microsoft.com/fwlink/p/?LinkID=522459) , чтобы сделать запрос.
