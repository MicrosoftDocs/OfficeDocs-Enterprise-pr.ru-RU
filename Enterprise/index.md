...
description: Microsoft Office 365 предоставляет мощные облачные службы, которые позволяют совместной работы, безопасности и соответствия требованиям, мобильности и intellgence и аналитики. На этой странице представлены рекомендации для администраторов и ИТ-специалистов, развертывание, Настройка и управление службами Office 365 в предприятиях.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Под руководством инструктора развертывания с помощью эту</h3>
                <p>Использование преимуществ центр эту для Office&nbsp;365 для под руководством инструктора помощник по планированию, развертыванию и управляет внедрения Office&nbsp;365 служб для вашей организации.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Миграция в Office 365</h3>
                <p>Перенос существующей инфраструктуры в локальной в Office&nbsp;корпорации Майкрософт и 365 в облаке.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Развертывание Office 365</h3>
                <p>Развертывание Office&nbsp;365, включая настройку вашего клиента, Настройка сети и подготовки пользователей.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                ...
                <p>Настройка и управление гибридным развертыванием между существующей локальной инфраструктуре и Office&nbsp;365.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Обучающие курсы по Office 365</h3>
                <p>Улучшения Office&nbsp;365 администрирования знания и навыки работы с Office&nbsp;365 курсы обучения для ИТ-специалистов.</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2>Развертывание рабочих нагрузок Office 365</h2>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3><a href="https://docs.microsoft.com/SkypeForBusiness/skype-for-business-online">Skype для бизнеса Online</a></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="https://techcommunity.microsoft.com/t5/Office-365/ct-p/Office365">Ознакомьтесь с рекомендациями, новости и последние тенденции и темы, связанные с Office&nbsp;365.</a></p>
                    </div>
                </div>
            </div>
        </div>
