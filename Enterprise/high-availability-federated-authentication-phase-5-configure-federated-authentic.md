...
2. На рабочем столе сервера синхронизации службы каталогов откройте Internet Explorer и перейдите по [https://aka.ms/aadconnect](https://aka.ms/aadconnect)адресу.
