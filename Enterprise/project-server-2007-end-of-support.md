...
ms.locfileid: "34071055"
---
# <a name="project-server-2007-end-of-support-roadmap"></a>План действий после прекращения поддержки Project Server 2007;

Поддержка серверов и приложений Office 2007 в 2017, а также необходимо учесть планы миграции. Если в настоящее время используется Project Server 2007, обратите внимание на то, что у него и другие связанные продукты будут следующие даты окончания поддержки:
