...
# Автоматизация сбора файлов для обнаружения электронных данных
...
### Подготовка общей папки для промежуточного хранения
...
|:-----|:-----|:-----|
|71  <br/> |Переменная **$FileTypes**. Включите расширения всех типов файлов, подлежащих инвентаризации и сбору в переменной массива с использованием сценария. <br/> |Необязательно  <br/> |
...
|80  <br/> |Переменную **$CaseRootLocation** необходимо настроить для общей папки коллекции промежуточных серверов, например **\\\\Staging\\Cases$**. <br/> |Обязательно  <br/> |
   
4. Поместите файл CollectionScript.ps1 в общую папку Netlogon на контроллере домена. 
    
### Настройте GPO для сценария входа и группы Custodians
...
### Вариант А импорта PST-файлов, сценарий для Exchange Server 2013
...
|**Номер строки**|**Необходимые изменения**|**Обязательно?**|
|:-----|:-----|:-----|
|12  <br/> |**$FolderIdentifier** помечает папки почтовых ящиков, в которые импортируются PST-файлы. При необходимости измените их. <br/> |Необязательное  <br/> |
...
### Вариант Б импорта PST-файлов для Exchange Online
...
### Автономное неструктурированное защищенное хранилище
...
### Локальный поиск защищенного хранилища в SharePoint
...
### Отслеживание сбора файлов и просмотр файлов журнала
...
### Вариант А импорта PST-файлов для Exchange Server 2013
...
### Перемещение в защищенное хранилище
