...
6. На странице **изменение ролей пользователей** щелкните **глобальный администратор**, введите **user4@contoso.com** **альтернативный адрес электронной почты**и нажмите кнопку **сохранить**. Щелкните **Закрыть** дважды.
...
12. На странице **изменение ролей пользователей** щелкните настраиваемый **Администратор**, выберите Администратор **паролей** и **администратор управления пользователями**, введите **user5@contoso.com** **альтернативный адрес электронной почты**и нажмите кнопку **сохранить**. Щелкните **Закрыть** дважды.
