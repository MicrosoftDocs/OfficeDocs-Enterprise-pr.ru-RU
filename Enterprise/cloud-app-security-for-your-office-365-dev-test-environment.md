...
# Cloud App Security для среды разработки и тестирования Office 365
...
> [!TIP]
> Щелкните [здесь](https://docs.com/officeitpro/4355/pdf-portal-ca-tlg-stack?c=ca4UTZ), чтобы просмотреть схему всех статей, относящихся к руководствам по лаборатории тестирования Microsoft Cloud. 
  
## Этап 1. Создание среды разработки и тестирования Office 365  упрощенной или для имитированных предприятий
...
## Этап 2. Перед включением Cloud App Security и созданием политики
...
### Проверка режима работы уведомлений по умолчанию в Office 365
...
## Этап 3. Включение Cloud App Security и создание политики
...
### Включение и настройка Cloud App Security

1. Перейдите на портал Office 365 ([https://portal.office.com](https://portal.office.co)) и войдите на странице пробной подписки на Office 365, используя учетную запись глобального администратора.
...
## Этап 4. Демонстрация Cloud App Security в действии
...
### Демонстрация уведомления по электронной почте об изменении в ролях учетных записей пользователей
