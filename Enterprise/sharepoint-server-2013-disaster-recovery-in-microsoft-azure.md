...
|:-----|:-----|:-----|:-----|
|C  <br/> |80  <br/> |Системный диск  <br/> |<буква­_диска>:\\Program Files\\Microsoft SQL Server\\  <br/> |
|E  <br/> |80  <br/> |Диск журналов (40 ГБ)  <br/> |<буква­_диска>:\\Program Files\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|F  <br/> |80  <br/> |Диск файла подкачки (36 ГБ)  <br/> |<буква­_диска>:\\Program Files\\Microsoft SQL Server\\MSSQL\\DATA  <br/> |
...
|**Буква диска**|**Размер**|**Имя каталога**|**Путь**|
|:-----|:-----|:-----|:-----|
|C  <br/> |80  <br/> |Корневой каталог данных  <br/> |<буква­_диска>:\\Program Files\\Microsoft SQL Server\\  <br/> |
|E  <br/> |500  <br/> |Каталог базы данных пользователей  <br/> |<буква­_диска>:\\Program Files\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|F  <br/> |500  <br/> |Каталог журнала базы данных пользователей  <br/> |<буква­_диска>:\\Program Files\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|G  <br/> |500  <br/> |Временный каталог БД  <br/> |<буква­_диска>:\\Program Files\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
|H  <br/> |500  <br/> |Временный каталог журнала БД  <br/> |<буква­_диска>:\\Program Files\\Microsoft SQL Server\\MSSQL10_50.MSSQLSERVER\\MSSQL\\DATA  <br/> |
...
Проверьте связи приложений-служб между семейством веб-сайтов контента и концентратором типов контента. Кроме того, перейдите на экран свойств **Управляемые метаданные  подключение к <имя семейства веб-сайтов>** и убедитесь, что включен параметр **Это приложение-служба является используемым по умолчанию местом хранения для наборов терминов, определяемых столбцом.**
...
### Ошибка создания группы доступности на этапе запуска сеанса XEvent "AlwaysOn_health" на сервере <имя сервера>
