...
Мы использовали параметр _скипрегистерасдистрибутедкачехост_ при запуске **Psconfig. exe** в командной строке. Дополнительные сведения см. [в статье Plan for Feeds and Distributed Cache Service in SharePoint Server 2013](https://docs.microsoft.com/sharepoint/administration/plan-for-feeds-and-the-distributed-cache-service). 
