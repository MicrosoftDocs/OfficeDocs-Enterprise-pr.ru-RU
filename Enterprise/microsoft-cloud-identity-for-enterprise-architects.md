...
[![Эскиз изображения для модели облачных удостоверений Microsoft](images/ffa145a1-97e6-4c36-b08b-01c4a4ae8b9b.png) 
...
> [!NOTE]
> В этой статье отражает версию 2016 января плакат **Microsoft Облачное удостоверение для архитекторов enterprise** . Не содержит изменений для апреля 2016 или более поздней версии афиши.
  
## <a name="designing-identity-for-the-microsoft-cloud"></a>Разработка удостоверения для облака Майкрософт
