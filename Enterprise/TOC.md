...
### [Сеть Microsoft Cloud для корпоративных архитекторов](microsoft-cloud-networking-for-enterprise-architects.md)
...
### [Облачное хранилище Майкрософт для корпоративных архитекторов](microsoft-cloud-storage-for-enterprise-architects.md)
#### [Проектирование хранилища для облака Майкрософт](designing-storage-for-the-microsoft-cloud.md)
...
#### [Идентификация для корпорации Contoso](identity-for-the-contoso-corporation.md)
...
### [Веб-сайты в Microsoft Azure, использующие SharePoint Server 2013](internet-sites-in-microsoft-azure-using-sharepoint-server-2013.md)
### [Автоматизация сбора файлов для обнаружения электронных данных](automate-file-collection-for-ediscovery.md)
## [Multi-Geo]()
### [OneDrive для бизнеса с поддержкой нескольких регионов](multi-geo-capabilities-in-onedrive-and-sharepoint-online-in-office-365.md)
...
#### [Обзор защиты информации в Office 365 в соответствии с GDPR](office-365-info-protection-for-gdpr-overview.md)
...
#### [Создание схемы классификации для персональных данных](architect-a-classification-schema-for-personal-data.md)
...
#### [GDPR для Skype для бизнеса Server](gdpr-for-skype-for-business-server.md)
...
#### [GDPR для Office Online Server](gdpr-for-office-online-server.md)
#### [GDPR для файловых ресурсов](gdpr-for-on-premises-file-shares.md)
...
#### [Обнаружение случаев незаконного предоставления разрешения и устранение их последствий](detect-and-remediate-illicit-consent-grants.md)
#### [Обнаружение и исправление форм и правил Outlook](detect-and-remediate-outlook-rules-forms-attack.md)
...
## [Переход с продуктов Office 2007 или 2010](plan-upgrade-previous-versions-office.md)
### [Office 2010](upgrade-from-office-2010-servers-and-products.md)
#### [Office 2010 для настольных ПК](/DeployOffice/office-2010-end-support-roadmap.md)
...
## [Управление Office 365 с помощью Office 365 PowerShell](powershell/manage-office-365-with-office-365-powershell.md)
