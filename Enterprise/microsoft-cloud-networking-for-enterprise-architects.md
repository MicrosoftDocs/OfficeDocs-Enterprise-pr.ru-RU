...
[![Бегунка изображения для Microsoft cloud сетевая модель](images/95e8ab6a-b4d0-4836-acc1-b0b77ebf46e6.png)  
...
30-минутный Обзор ключевые моменты на этом плакате [Оптимизация вашей сети для Microsoft облака](https://mva.microsoft.com/en-US/training-courses/optimize-your-network-for-microsoft-cloud-offerings-17743) Microsoft Virtual Academy см.
  
> [!NOTE]
> В этих статьях отражен выпуск плаката "Облачные сети Майкрософт для корпоративных архитекторов" за **июнь 2017 г.**
