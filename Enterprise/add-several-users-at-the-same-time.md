...
## <a name="add-multiple-users-to-office-365-in-the-office-365-admin-center"></a>Добавление нескольких пользователей в Office 365, используя Центр администрирования Office 365

1. Войдите в Office 365 с рабочей или учебной учетной записью. 
    
2. Войдите в Центр администрирования Office 365 и выберите элементы **Пользователи** \> **Активные пользователи**.
    
    ![In the Admin center choose Users and then Active users](media/12086d98-a8b4-4c48-89cf-b78ad8058ff1.png)
  
3. В раскрывающемся списке **Еще** выберите команду **Импорт нескольких пользователей**.
...
## <a name="add-multiple-users-to-office-365-in-the-old-office-365-admin-center"></a>Добавление нескольких пользователей в Office 365, используя старый Центр администрирования Office 365
...
9. На странице назначения лицензий указано количество доступных лицензий. 
    ...
    Вы можете выбрать **Приобретение дополнительных лицензий**, но при этом мастер прекратит работу и вы перейдете в раздел **Выставление счетов**, Центр администрирования Office 365. После покупки дополнительных лицензий подождите несколько минут, чтобы мы успели обработать ваш заказ, и снова запустите мастер массового добавления пользователей. 
