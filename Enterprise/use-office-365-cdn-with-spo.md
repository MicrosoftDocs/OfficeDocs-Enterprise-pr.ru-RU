...
> + CDN Office 365 в настоящее время не поддерживает клиенты, настроенные с помощью пользовательских или "запоминающийся" доменов. Если вы добавили домен в любой компонент клиента Office 365, выполнив инструкции, приведенные в разделе [Добавление домена в office 365](https://docs.microsoft.com/en-us/office365/admin/setup/add-domain?view=o365-worldwide), то при попытке доступа к контенту из сети cdn Office 365s будет возвращать ошибки.
