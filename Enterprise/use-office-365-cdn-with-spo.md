...
> [!NOTE]
> Ограничения для использования сети CDN Office 365:
...
> + CDN Office 365 в настоящее время не поддерживает клиенты, настроенные с помощью пользовательских или "запоминающийся" доменов. Если вы добавили домен в клиент, выполнив инструкции, приведенные в разделе [Добавление домена в office 365](https://docs.microsoft.com/en-us/office365/admin/setup/add-domain?view=o365-worldwide), то при попытке получить доступ к контенту из CDN cdn Office 365 будет возвращать ошибки.
