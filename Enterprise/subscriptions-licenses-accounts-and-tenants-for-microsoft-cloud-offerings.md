...
|:-----|:-----|:-----|:-----|:-----|
|**Office 365** <br/> |Н/Д  <br/> |Добавьте подписку Azure для организации с помощью портала Azure.  <br/> |Добавьте подписку Intune/EMS для организации с помощью портала Office 365.  <br/> |Добавьте подписку на Dynamics 365 для организации на портале Office 365.  <br/> |
...
1. Войдите на портал Office 365 ([https://portal.office.com](https://portal.office.com)), используя учетную запись глобального администратора, и выберите **Администрирование**.
