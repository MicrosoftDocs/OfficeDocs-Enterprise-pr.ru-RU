...
- [Облачная проверка](about-office-365-identity.md#cloud-authentication) подлинности — создание пользователей и управление ими в центре администрирования Office 365 Кроме того, вы можете использовать Windows PowerShell или Azure Active Directory для управления пользователями. 
...
[Использование домена для интеграции с локальной службой электронной почты, например с помощью службы каталогов](office-365-integration.md)
